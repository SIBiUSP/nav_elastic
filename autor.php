...
<?php if(isset($_GET["format"])) : ?>
    ...
    <?php elseif($_GET["format"] == "tableThesis") : ?>
    ...
    <div class="uk-overflow-auto">
        <table class="uk-table">
            ...
            <thead>
                <tr>
                    <th>Sysno</th>
                    <th>Número de chamada completo</th>
                    <th>Número USP</th>
                    <th>Nome Citação (946$a)</th>
                    <th>Nome Citação (100$a)</th>
                    <th>Nome Orientador (700$a)</th>
                    <th>Núm USP Orientador (946$o)</th>
                ...
                <tr>
                    ...
                    <?php foreach ($r["_source"]['authorUSP'] as $numUSP_aut) {
                        if (!empty($numUSP_aut["codpesOrientador"])) {
                            echo '<td>'. $numUSP_aut["codpesOrientador"].'</td>';
                        } else {
                    ...
                    <td>Não foi possível coletar</td>
                    <td>Não foi possível coletar</td>
                    <td><?php if (!empty($r["_source"]['datePublished'])) { echo $r["_source"]['datePublished']; } ?></td>
                    <td>
                        <?php if (!empty($r["_source"]['publisher']['organization']['location'])) {
