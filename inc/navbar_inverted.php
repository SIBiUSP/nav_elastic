    ...
    <nav class="uk-container uk-navbar-container uk-margin uk-navbar-transparent" uk-navbar="dropbar: true; dropbar-mode: push; mode: click">      
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active"><a href="index.php" style="color:#fff"><?php echo $t->gettext('Início'); ?></a></li>
            </ul>
        </div>
        ...
        <div class="uk-navbar-right">
            <ul class="uk-navbar-nav">
                ...
                <li class="uk-active">
                    <a href="sobre.php" style="color:#fff"><?php echo $t->gettext('Sobre'); ?></a>     
                </li>
                <!-- 
                <li class="uk-active">
                    <a href="" class="" aria-expanded="false" style="color:#fff">< ?php echo $t->gettext('Usuário'); ?></a>
