    ...
    <div class="uk-container uk-navbar-container uk-margin uk-navbar-transparent" uk-navbar="dropbar: true; dropbar-mode: push; mode: click" uk-navbar>      
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                ...
                <li class="uk-active">
                    <a href="<?php echo $url_base; ?>/tutorial/"><?php echo $t->gettext('Tutorial'); ?></a>
                </li>                
             </ul>
        </div>
        <div class="uk-navbar-center">
            <a class="uk-navbar-item uk-logo" href="<?php echo $url_base; ?>/index.php"><img src="http://www.scs.usp.br/identidadevisual/wp-content/uploads/2013/08/usp-logo-png.png" width="110px"></a>
        </div>
